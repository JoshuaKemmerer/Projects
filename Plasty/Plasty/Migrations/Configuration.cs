...
namespace Plasty.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Plasty.DAL.PlastyDbContext>
    {
        ...
        protected override void Seed(Plasty.DAL.PlastyDbContext context)
        {
